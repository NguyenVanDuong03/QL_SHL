                    ...
                    <div class="card feature-card">
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                <a href="{{ route('student.class-session.index') }}" class="btn btn-primary-custom">Xem lịch</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card feature-card">
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                <a href="{{ route('student.conduct-score.index') }}" class="btn btn-primary-custom">Chấm điểm</a>
                            </div>
                        </div>
                    </div>
                </div>
