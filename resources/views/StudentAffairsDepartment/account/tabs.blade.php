        ...
        <div class="col-12">
            ...
            <ul class="nav nav-tabs" id="accountTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ request()->routeIs('student-affairs-department.account.index') ? 'active' : '' }}"
                       href="{{ route('student-affairs-department.account.index') }}">
                        Danh sách tài khoản giáo viên
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ request()->routeIs('student-affairs-department.account.student') ? 'active' : '' }}"
