...
@section('breadcrumb')
    <x-breadcrumb.breadcrumb :links="[
        ...
        ['label' => 'Danh sách lớp học', 'url' => 'faculty-office.conduct-score.infoConductScore', 'params' => ['conduct_evaluation_period_id' => $data['conduct_evaluation_period_id']]],
            ...
            <div class="col-12">
                <div class="mb-4">
                    <div class="d-md-flex justify-content-between align-items-center mb-3">
                        <a href="{{ route('faculty-office.conduct-score.infoConductScore', ['conduct_evaluation_period_id' => $data['conduct_evaluation_period_id']]) }}"
                ...
                <div class="d-flex justify-content-end mb-4">
                    <form method="GET" action="{{ route('faculty-office.conduct-score.list') }}" class="position-relative">
                            ...
                            @forelse($data['listConductScores']['data'] ?? [] as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('faculty-office.conduct-score.detail', ['student_id' => $item['student_id'], 'conduct_evaluation_period_id' => $data['conduct_evaluation_period_id'], 'study_class_id' => $data['study_class_id'] ]) }}"
