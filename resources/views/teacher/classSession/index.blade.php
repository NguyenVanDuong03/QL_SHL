    ...
    <div class="p-4">
        ...
        <div class="row mb-4">
            <div class="col-md-6" style="height: 130px">
                <div class="card shadow-sm h-100">
                    <div class="card-body position-relative">
                        <h5 class="card-title">SINH HOẠT LỚP CỐ ĐỊNH</h5>
                        ...
                        @endif
                        <a class="btn btn-primary position-absolute {{ $data['checkClassSessionRegistration'] ? '' : 'disabled' }}"
            ...
            <div class="col-md-6 class-flexible-m" style="height: 130px">
                <div class="card shadow-sm h-100">
                    <div class="card-body position-relative">
                        <h5 class="card-title">SINH HOẠT LỚP LINH HOẠT</h5>
