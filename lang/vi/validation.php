...
return [
    ...
    | lớp validator. Một số luật có nhiều phiên bản khác nhau
    | như các luật về kích thước. Bạn có thể thoải mái chỉnh sửa các thông báo này.
    |
    */
    ...
    'extensions' => 'Trường :attribute phải có phần mở rộng là một trong các giá trị: :values.',
    ...
    'mimes' => 'Trường :attribute phải là tệp với kiểu: :values.',
    'mimetypes' => 'Trường :attribute phải là tệp với kiểu: :values.',
    'min' => [
    ...
    'password' => [
        ...
        'uncompromised' => ':attribute được cung cấp đã xuất hiện trong dữ liệu bị rò rỉ. Vui lòng chọn :attribute khác.',
    ],
    ...
    | theo quy ước "attribute.rule" để đặt tên dòng. Điều này giúp bạn nhanh chóng
    | chỉ định một thông báo riêng cho quy tắc của một thuộc tính cụ thể.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau được sử dụng để thay thế placeholder attribute
    | bằng một thứ gì đó thân thiện hơn với người đọc như "Địa chỉ Email" thay vì "email".
    | Điều này giúp thông báo của chúng ta dễ hiểu hơn.
    |
    */
